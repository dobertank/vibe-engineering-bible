# CLAUDE.md / AGENTS.md (универсальный)
...
>
> Это **универсальный** baseline, дефолт для любой команды любого размера
> (соло-разработчик, OSS-мейнтейнер, команда из 5 или 50 человек). Он не
> требует Backstage, корпоративного AI-Gateway, корп-Slack-каналов или
> обязательного PR-шаблона. Если у вас все эти слои развёрнуты — берите
> `templates/CLAUDE.md.template.enterprise.md` вместо этого файла.
...
в §5 «Библии». Корпоративные строки `[ENT]` (регламентированный релиз T3 —
ИФТ/НТ/ЦКБ/PoB/«вывод в ПРОМ») в этом универсальном шаблоне опущены; команды
без такого процесса достигают тех же гарантий через CI/CD, релиз-чек-лист
и runbook. Полный enterprise-вариант — в `templates/CLAUDE.md.template.enterprise.md`
и Appendix A библии.
