...
Новый язык / фреймворк / тяжёлая runtime-зависимость — только через ADR и одобрение platform-owner (Principal Engineer Community / Architecture Council). См. Заповедь IV библии + Appendix C.
...
- **MCP-серверы и сторонние Cursor/IDE-расширения** — только из корпоративного
  allow-list. Известные RCE-цепочки 2025: CVE-2025-54135 («CurXecute»),
