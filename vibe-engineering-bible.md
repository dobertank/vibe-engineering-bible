...
**Каталог сервисов.** Backstage с обязательными метаданными (см. docs/adoption-roadmap.md, Профиль III, Фаза 1).
